...
module Range =
    ...
    let __linearBoundedInt8 : Range<int8> = linearBounded ()
    
    /// Construct a range which is scaled relative to the size parameter and
    /// uses the full range of a data type.
    [<CompiledName("LinearBoundedInt16")>]
    let __linearBoundedInt16 : Range<Int16> = linearBounded ()
        
    /// Construct a range which is scaled relative to the size parameter and
    /// uses the full range of a data type.
    [<CompiledName("LinearBoundedInt32")>]
    let __linearBoundedInt32 : Range<Int32> = linearBounded ()

    /// Construct a range which is scaled relative to the size parameter and
    /// uses the full range of a data type.
    [<CompiledName("LinearBoundedInt64")>]
    let __linearBoundedInt64 : Range<Int64> = linearBounded ()

    /// Construct a range which is scaled relative to the size parameter and
    /// uses the full range of a data type.
    [<CompiledName("LinearBoundedUInt8")>]
    let __linearBoundedUInt8 : Range<uint8> = linearBounded ()
    
    /// Construct a range which is scaled relative to the size parameter and
    /// uses the full range of a data type.
    [<CompiledName("LinearBoundedUInt16")>]
    let __linearBoundedUInt16 : Range<UInt16> = linearBounded ()

    /// Construct a range which is scaled relative to the size parameter and
    /// uses the full range of a data type.
    [<CompiledName("LinearBoundedUInt32")>]
    let __linearBoundedUInt32 : Range<UInt32> = linearBounded ()

    /// Construct a range which is scaled relative to the size parameter and
    /// uses the full range of a data type.
    [<CompiledName("LinearBoundedUInt64")>]
    let __linearBoundedUInt64 : Range<UInt64> = linearBounded ()
    
    /// Construct a range which is scaled relative to the size parameter and
    /// uses the full range of a data type.
    [<CompiledName("LinearBoundedFloat")>]
    let __linearBoundedFloat : Range<float> = linearBounded ()

    /// Construct a range which is scaled relative to the size parameter and
    /// uses the full range of a data type.
    [<CompiledName("LinearBoundedDouble")>]
    let __linearBoundedDouble : Range<double> = linearBounded ()

    /// Construct a range which is scaled relative to the size parameter and
    /// uses the full range of a data type.
    [<CompiledName("LinearBoundedDecimal")>]
    let __linearBoundedDecimal : Range<decimal> = linearBounded ()
    ...
    let __exponentialFromInt8(z,x,y) : Range<int8> = exponentialFrom z x y
    
    /// Construct a range which scales the bounds exponentially relative to the
    /// size parameter.
    [<CompiledName("ExponentialFromInt16")>]
    let __exponentialFromInt16(z,x,y) : Range<Int16> = exponentialFrom z x y
        
    /// Construct a range which scales the bounds exponentially relative to the
    /// size parameter.
    [<CompiledName("ExponentialFromInt32")>]
    let __exponentialFromInt32(z,x,y) : Range<Int32> = exponentialFrom z x y

    /// Construct a range which scales the bounds exponentially relative to the
    /// size parameter.
    [<CompiledName("ExponentialFromInt64")>]
    let __exponentialFromInt64(z,x,y) : Range<Int64> = exponentialFrom z x y

    /// Construct a range which scales the bounds exponentially relative to the
    /// size parameter.
    [<CompiledName("ExponentialFromUInt8")>]
    let __exponentialFromUInt8(z,x,y) : Range<uint8> = exponentialFrom z x y
    
    /// Construct a range which scales the bounds exponentially relative to the
    /// size parameter.
    [<CompiledName("ExponentialFromUInt16")>]
    let __exponentialFromUInt16(z,x,y) : Range<UInt16> = exponentialFrom z x y

    /// Construct a range which scales the bounds exponentially relative to the
    /// size parameter.
    [<CompiledName("ExponentialFromUInt32")>]
    let __exponentialFromUInt32(z,x,y) : Range<UInt32> = exponentialFrom z x y

    /// Construct a range which scales the bounds exponentially relative to the
    /// size parameter.
    [<CompiledName("ExponentialFromUInt64")>]
    let __exponentialFromUInt64(z,x,y) : Range<UInt64> = exponentialFrom z x y
    
    /// Construct a range which scales the bounds exponentially relative to the
    /// size parameter.
    [<CompiledName("ExponentialFromFloat")>]
    let __exponentialFromFloat(z,x,y) : Range<float> = exponentialFrom z x y

    /// Construct a range which scales the bounds exponentially relative to the
    /// size parameter.
    [<CompiledName("ExponentialFromDouble")>]
    let __exponentialFromDouble(z,x,y) : Range<double> = exponentialFrom z x y

    /// Construct a range which scales the bounds exponentially relative to the
    /// size parameter.
    [<CompiledName("ExponentialFromDecimal")>]
    let __exponentialFromDecimal(z,x,y) : Range<decimal> = exponentialFrom z x y
    ...
    let __exponentialInt8(x,y) : Range<int8> = exponential x y
    
    /// Construct a range which scales the second bound exponentially relative
    /// to the size parameter.
    [<CompiledName("ExponentialInt16")>]
    let __exponentialInt16(x,y) : Range<Int16> = exponential x y
        
    /// Construct a range which scales the second bound exponentially relative
    /// to the size parameter.
    [<CompiledName("ExponentialInt32")>]
    let __exponentialInt32(x,y) : Range<Int32> = exponential x y

    /// Construct a range which scales the second bound exponentially relative
    /// to the size parameter.
    [<CompiledName("ExponentialInt64")>]
    let __exponentialInt64(x,y) : Range<Int64> = exponential x y

    /// Construct a range which scales the second bound exponentially relative
    /// to the size parameter.
    [<CompiledName("ExponentialUInt8")>]
    let __exponentialUInt8(x,y) : Range<uint8> = exponential x y
    
    /// Construct a range which scales the second bound exponentially relative
    /// to the size parameter.
    [<CompiledName("ExponentialUInt16")>]
    let __exponentialUInt16(x,y) : Range<UInt16> = exponential x y

    /// Construct a range which scales the second bound exponentially relative
    /// to the size parameter.
    [<CompiledName("ExponentialUInt32")>]
    let __exponentialUInt32(x,y) : Range<UInt32> = exponential x y

    /// Construct a range which scales the second bound exponentially relative
    /// to the size parameter.
    [<CompiledName("ExponentialUInt64")>]
    let __exponentialUInt64(x,y) : Range<UInt64> = exponential x y
    
    /// Construct a range which scales the second bound exponentially relative
    /// to the size parameter.
    [<CompiledName("ExponentialFloat")>]
    let __exponentialFloat(x,y) : Range<float> = exponential x y

    /// Construct a range which scales the second bound exponentially relative
    /// to the size parameter.
    [<CompiledName("ExponentialDouble")>]
    let __exponentialDouble(x,y) : Range<double> = exponential x y

    /// Construct a range which scales the second bound exponentially relative
    /// to the size parameter.
    [<CompiledName("ExponentialDecimal")>]
    let __exponentialDecimal(x,y) : Range<decimal> = exponential x y
    ...
    let __exponentialBoundedInt8 : Range<int8> = exponentialBounded ()
    
    /// Construct a range which is scaled exponentially relative to the size
    /// parameter and uses the full range of a data type.
    [<CompiledName("ExponentialBoundedInt16")>]
    let __exponentialBoundedInt16 : Range<Int16> = exponentialBounded ()
        
    /// Construct a range which is scaled exponentially relative to the size
    /// parameter and uses the full range of a data type.
    [<CompiledName("ExponentialBoundedInt32")>]
    let __exponentialBoundedInt32 : Range<Int32> = exponentialBounded ()

    /// Construct a range which is scaled exponentially relative to the size
    /// parameter and uses the full range of a data type.
    [<CompiledName("ExponentialBoundedInt64")>]
    let __exponentialBoundedInt64 : Range<Int64> = exponentialBounded ()

    /// Construct a range which is scaled exponentially relative to the size
    /// parameter and uses the full range of a data type.
    [<CompiledName("ExponentialBoundedUInt8")>]
    let __exponentialBoundedUInt8 : Range<uint8> = exponentialBounded ()
    
    /// Construct a range which is scaled exponentially relative to the size
    /// parameter and uses the full range of a data type.
    [<CompiledName("ExponentialBoundedUInt16")>]
    let __exponentialBoundedUInt16 : Range<UInt16> = exponentialBounded ()

    /// Construct a range which is scaled exponentially relative to the size
    /// parameter and uses the full range of a data type.
    [<CompiledName("ExponentialBoundedUInt32")>]
    let __exponentialBoundedUInt32 : Range<UInt32> = exponentialBounded ()

    /// Construct a range which is scaled exponentially relative to the size
    /// parameter and uses the full range of a data type.
    [<CompiledName("ExponentialBoundedUInt64")>]
    let __exponentialBoundedUInt64 : Range<UInt64> = exponentialBounded ()
    
    /// Construct a range which is scaled exponentially relative to the size
    /// parameter and uses the full range of a data type.
    [<CompiledName("ExponentialBoundedFloat")>]
    let __exponentialBoundedFloat : Range<float> = exponentialBounded ()

    /// Construct a range which is scaled exponentially relative to the size
    /// parameter and uses the full range of a data type.
    [<CompiledName("ExponentialBoundedDouble")>]
    let __exponentialBoundedDouble : Range<double> = exponentialBounded ()

    /// Construct a range which is scaled exponentially relative to the size
    /// parameter and uses the full range of a data type.
    [<CompiledName("ExponentialBoundedDecimal")>]
    let __exponentialBoundedDecimal : Range<decimal> = exponentialBounded ()
