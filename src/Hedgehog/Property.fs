...
module Property =
    ...
    [<CompiledName("CheckForAll")>]
    let checkForAll (g1 : Gen<'t1>) (k : Action<'t1>) : unit =
        check (forAll g1 (fun x1 -> fromThrowing k.Invoke x1))

    [<CompiledName("CheckForAll")>]
    let checkForAllBool (g1 : Gen<'t1>) (k : Func<'t1, bool>) : unit =
        check (forAll g1 (k.Invoke >> ofBool))
    ...
    let checkForAll2
        ...
        check (
            forAll g1 (fun x1 ->
            forAll g2 (fun x2 ->
                fromThrowing k.Invoke (x1, x2))))

    [<CompiledName("CheckForAll")>]
    let checkForAll2Bool
        (g1 : Gen<'t1>)
        (g2 : Gen<'t2>)
        (k : Func<'t1, 't2, bool>) : unit =
        check (
            forAll g1 (fun x1 ->
            forAll g2 (fun x2 ->
                ofBool (k.Invoke (x1, x2)))))
    ...
    let checkForAll3
        ...
        (g2 : Gen<'t2>)
        (g3 : Gen<'t3>)
        (k : Action<'t1, 't2, 't3>) : unit =
        check (
            forAll g1 (fun x1 ->
            forAll g2 (fun x2 ->
            forAll g3 (fun x3 ->
                fromThrowing k.Invoke (x1, x2, x3)))))

    [<CompiledName("CheckForAll")>]
    let checkForAll3Bool
        (g1 : Gen<'t1>)
        (g2 : Gen<'t2>)
        (g3 : Gen<'t3>)
        (k : Func<'t1, 't2, 't3, bool>) : unit =
        check (
            forAll g1 (fun x1 ->
            forAll g2 (fun x2 ->
            forAll g3 (fun x3 ->
                ofBool (k.Invoke (x1, x2, x3))))))
    ...
    let checkForAll4
        ...
        (g3 : Gen<'t3>)
        (g4 : Gen<'t4>)
        (k : Action<'t1, 't2, 't3, 't4>) : unit =
        check (
            forAll g1 (fun x1 ->
            forAll g2 (fun x2 ->
            forAll g3 (fun x3 ->
            forAll g4 (fun x4 ->
                fromThrowing k.Invoke (x1, x2, x3, x4))))))

    [<CompiledName("CheckForAll")>]
    let checkForAll4Bool
        (g1 : Gen<'t1>)
        (g2 : Gen<'t2>)
        (g3 : Gen<'t3>)
        (g4 : Gen<'t4>)
        (k : Func<'t1, 't2, 't3, 't4, bool>) : unit =
        check (
            forAll g1 (fun x1 ->
            forAll g2 (fun x2 ->
            forAll g3 (fun x3 ->
            forAll g4 (fun x4 ->
                ofBool (k.Invoke (x1, x2, x3, x4)))))))
    ...
    let checkForAll5
        ...
        check (
            ...
            forAll g4 (fun x4 ->
            forAll g5 (fun x5 ->
                fromThrowing k.Invoke (x1, x2, x3, x4, x5)))))))

    [<CompiledName("CheckForAll")>]
    let checkForAll5Bool
        (g1 : Gen<'t1>)
        (g2 : Gen<'t2>)
        (g3 : Gen<'t3>)
        (g4 : Gen<'t4>)
        (g5 : Gen<'t5>)
        (k : Func<'t1, 't2, 't3, 't4, 't5, bool>) : unit =
        check (
            forAll g1 (fun x1 ->
            forAll g2 (fun x2 ->
            forAll g3 (fun x3 ->
            forAll g4 (fun x4 ->
            forAll g5 (fun x5 ->
                ofBool (k.Invoke (x1, x2, x3, x4, x5))))))))
